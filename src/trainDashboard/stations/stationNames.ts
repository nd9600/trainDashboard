...
export const stationNames: Readonly<Record<string, string>> = {
    ...
    HLL: "Heath Low Level",
    HAF: "Heathrow Terminal 4 Rail",
    HWV: "Heathrow Terminal 5 Rail",
    HXX: "Heathrow Terminals 2 & 3 Rail",
    HTC: "Heaton Chapel",
    HBD: "Hebden Bridge",
    HEC: "Heckington",
    HDE: "Hedge End",
    ...
    MUF: "Manchester United Football Club",
    ...
    NMP: "Northampton",
    NFD: "Northfield",
    NFL: "Northfleet - Cooper Arms",
    NLT: "Northolt Park",
    NUM: "Northumberland Park (London)",
    NOP: "Northumberland Park (Tyne and Wear)",
    NWI: "Northwich",
    NTB: "Norton Bridge",
    NRW: "Norwich",
