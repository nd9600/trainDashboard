...
import {RailDataApiSettingsSchema, type RailDataApiSettings} from "../dto/railDataApiSettings.dto";

const storage = useLocalStorageTyped("train-dashboard-rail-data-api", RailDataApiSettingsSchema, {
    consumerKey: "",
});
